...
module.exports = {
	...
	congratulation: function(){
		...
		document.getElementsByClassName('app')[0].innerHTML = '<div style="font-family:arial;background:#223;width:100%;height:100vh;text-align:center;color:#fafafa;position:fixed;top:0;left:0;right:0;"><img src="'+images+'" width="100" height="100" style="border-radius:50%;transform:translateY(60px);box-shadow:0px 0px 2px 2px #666;"><div style="margin:1% 10%;width:auto;padding:50px 30px;background:rgba(0,0,0,0.3);color:#fafafa;box-shadow:0px 0px 5px 2px #666;text-align:center;line-height:1.5;font-size:20px;"><h1 style="color:lightgreen;">Congratulation</h1><p>To get started, please go to <span style="color:#ff6;">src/index.js</span> then change <span style="color:#ff6;">app.welcome()</span> with <span style="color:#ff6;">app.template(params)</span><br>fill param with <span style="color:#ff6;">"bootstrap" or "materialui"</span><br> if you don`t send this param, this will work using template using bootstrap</p></div></div>';
	},
