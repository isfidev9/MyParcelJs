...
import('./app').then(function (app) {
	...
	// ---------------------------------------------------
	// mark this script, only if you want to get started
	// ---------------------------------------------------
	app.welcome();

	// template(this using, this content)
	// -----------------------------------------------------------------
	// 	mark the script above and remove the mark the script below 
	// is just an example of the display for you to see
	// -----------------------------------------------------------------
